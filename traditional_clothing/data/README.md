...
| 有效样本 | **2,140 条**（另有 722 条被形制规则剔除，如"袖口宽 = 袖根宽"违反 袖口<袖根<膨起） |
| **组件覆盖** | **12 个（全部）**：领型 交领/圆领/立领/对襟 · 袖型 广袖/窄袖/琵琶袖 · 下裳 襦裙/马面裙 · 配饰 云肩/褙子/半臂 |
| **朝代覆盖** | **6 代**：汉 330 / 魏晋 54 / 唐 432 / 宋 452 / 明 662 / 清 210 |
| 可执行性 | **100%**（每条都真实执行过 `assembly()` 产出纸样，`meta.verified = true`） |
| 监督信号 | 中文制版说明（3 句式）× caption（D2GC 路径标签）× 设计配置 × 目标代码 × 纸样统计 |
